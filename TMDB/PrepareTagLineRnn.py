...
class PrepareTagLineRnn(object):
    ...
    def prepare_data(self):
        ...
        self.__tok.fit_on_texts(self.__train_feature["tagline"])
        self.__train_feature = self.__tok.texts_to_sequences(self.__train_feature["tagline"])
        self.__test_feature = self.__tok.texts_to_sequences(self.__test_feature["tagline"])
    ...
    def write_data(self):
        pd.Series(self.__oof_preds) \
            .to_frame("train_rnn_tagline") \
            .to_csv(os.path.join(self.__output_path, "train_rnn_tagline.csv"), index=False)
        pd.Series(self.__sub_preds) \
            .to_frame("test_rnn_tagline") \
            .to_csv(os.path.join(self.__output_path, "test_rnn_tagline.csv"), index=False)
